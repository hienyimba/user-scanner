...
final class FreesoundValidator extends BaseGeneratedValidator
{
    ...
    {
        return 'https://freesound.org/people';
    }
    ...
    {
        return "https://freesound.org/people/{$target}/section/stats/?ajax=1";
    }
    ...
    protected function parseConnectorResponse(Response $response, string $target): array
    {
        ...
        $takenStatuses = [200];
        $availableIndicators = ['page not found'];
        $takenIndicators = ['forum posts'];
