...
final class DestreamValidator extends BaseGeneratedValidator
{
    ...
    {
        return 'https://destream.net/live';
    }
    ...
    {
        return "https://api.destream.net/siteapi/v2/live/details/{$target}";
    }
