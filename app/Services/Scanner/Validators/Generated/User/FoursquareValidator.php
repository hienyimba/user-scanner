...
// parity-source: C:/Users/hieny/GitHub/user-scanner/user-scanner-py-june-release/user_scanner/user_scan/social/foursquare.py
...
final class FoursquareValidator extends BaseGeneratedValidator
{
    ...
    {
        return "https://foursquare.com/{$target}";
    }
    ...
    protected function buildStructuredMetadata(Response $response, string $target, string $status): array
    {
        ...
        $displayName = $this->extractDisplayName($profileTitle, 'Foursquare');
