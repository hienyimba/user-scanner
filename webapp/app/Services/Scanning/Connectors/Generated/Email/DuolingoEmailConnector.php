...
class DuolingoEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://duolingo.com/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://duolingo.com',
            'Referer' => 'https://duolingo.com/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'duolingo',
    ...
    {
        return ['duolingo account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create duolingo account', 'email available', 'not registered', 'sign up'];
    }
