...
class VivinoEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://vivino.com/api/users/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://vivino.com',
            'Referer' => 'https://vivino.com/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'vivino',
