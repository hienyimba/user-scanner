...
class DevrantEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://devrant.com/api/check-email';
    }
    ...
    {
        return ['devrant account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create devrant account', 'email available', 'not registered', 'sign up'];
    }
