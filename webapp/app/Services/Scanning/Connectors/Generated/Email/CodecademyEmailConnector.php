...
class CodecademyEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://codecademy.com/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://codecademy.com',
            'Referer' => 'https://codecademy.com/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'codecademy',
    ...
    {
        return ['codecademy account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create codecademy account', 'email available', 'not registered', 'sign up'];
    }
