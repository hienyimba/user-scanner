...
class GumroadEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://gumroad.com/api/check-email';
    }
    ...
    {
        return ['gumroad account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create gumroad account', 'email available', 'not registered', 'sign up'];
    }
