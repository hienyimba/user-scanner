...
class FoxnewsEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://id.fox.com/status/v1/status/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://id.fox.com/status/v1/status',
            'Referer' => 'https://id.fox.com/status/v1/status/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'foxnews',
