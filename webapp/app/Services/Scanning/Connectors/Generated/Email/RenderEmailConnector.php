...
class RenderEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://api.render.com/graphql/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://api.render.com/graphql',
            'Referer' => 'https://api.render.com/graphql/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'render',
            'X-Scanner-Category' => 'hosting',
            'Host' => 'api.render.com',
        ];
    }
    ...
    {
        return ['render account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create render account', 'email available', 'not registered', 'sign up'];
    }
