...
class EspnEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://registerdisney.go.com/jgc/v8/client/ESPN-ONESITE.WEB-PROD/guest-flow';
    }
    ...
    {
        return 'https://registerdisney.go.com/jgc/v8/client/ESPN-ONESITE.WEB-PROD/guest-flow/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://registerdisney.go.com/jgc/v8/client/ESPN-ONESITE.WEB-PROD/guest-flow',
            'Referer' => 'https://registerdisney.go.com/jgc/v8/client/ESPN-ONESITE.WEB-PROD/guest-flow/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'espn',
    ...
    {
        return ['espn account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create espn account', 'email available', 'not registered', 'sign up'];
    }
