...
class AdobeEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://adobe.com/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Referer' => 'https://adobe.com/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'adobe',
    ...
    {
        return ['adobe account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create adobe account', 'email available', 'not registered', 'sign up'];
    }
