...
class GlobaltimesEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://globaltimes.cn/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://globaltimes.cn',
            'Referer' => 'https://globaltimes.cn/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'globaltimes',
