...
class AddictinggamesEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://addictinggames.com/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'X-Scanner-Connector' => 'addictinggames',
    ...
    {
        return ['addictinggames account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create addictinggames account', 'email available', 'not registered', 'sign up'];
    }
