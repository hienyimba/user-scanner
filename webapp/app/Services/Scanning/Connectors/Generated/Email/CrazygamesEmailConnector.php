...
class CrazygamesEmailConnector extends BaseEmailConnector
{
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'X-Scanner-Connector' => 'crazygames',
    ...
    {
        return ['crazygames account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create crazygames account', 'email available', 'not registered', 'sign up'];
    }
