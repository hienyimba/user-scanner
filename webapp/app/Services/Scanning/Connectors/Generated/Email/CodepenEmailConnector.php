...
class CodepenEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://codepen.io/api/check-email';
    }
    ...
    {
        return ['codepen account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create codepen account', 'email available', 'not registered', 'sign up'];
    }
