...
class FlirtbateEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://api.flirtbate.com/api/v1/customer/reset-password-email/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://api.flirtbate.com/api/v1/customer/reset-password-email',
            'Referer' => 'https://api.flirtbate.com/api/v1/customer/reset-password-email/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'flirtbate',
            'X-Scanner-Category' => 'adult',
            'Host' => 'api.flirtbate.com',
        ];
    }
