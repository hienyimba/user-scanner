...
class SaashubEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://saashub.com/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://saashub.com',
            'Referer' => 'https://saashub.com/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'saashub',
    ...
    {
        return ['saashub account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create saashub account', 'email available', 'not registered', 'sign up'];
    }
