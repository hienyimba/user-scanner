...
class HuggingfaceEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://huggingface.co/api/check-user-email/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://huggingface.co/api/check-user-email',
            'Referer' => 'https://huggingface.co/api/check-user-email/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'huggingface',
    ...
    {
        return ['huggingface account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create huggingface account', 'email available', 'not registered', 'sign up'];
    }
