...
class StremioEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://stremio.com/api/check-email';
    }
    ...
    {
        return ['stremio account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create stremio account', 'email available', 'not registered', 'sign up'];
    }
