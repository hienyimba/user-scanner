...
class InsightlyEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://insightly.com/users/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://insightly.com',
            'Referer' => 'https://insightly.com/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'insightly',
    ...
    {
        return ['insightly account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create insightly account', 'email available', 'not registered', 'sign up'];
    }
