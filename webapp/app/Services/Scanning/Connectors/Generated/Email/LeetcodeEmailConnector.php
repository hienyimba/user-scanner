...
class LeetcodeEmailConnector extends BaseEmailConnector
{
    ...
    {
        return '/accounts/check_email/';
    }

    protected function probeUrl(): string
    {
        return 'https://leetcode.com/accounts/check_email/';
    }
    ...
    {
        return ['leetcode account exists', 'already registered', 'already in use', 'email exists'];
    }
    ...
    {
        return ['create leetcode account', 'email available', 'not registered', 'sign up'];
    }
