...
class IndiatimesEmailConnector extends BaseEmailConnector
{
    ...
    {
        return 'https://timesofindia.com/api/check-email';
    }
    ...
    protected function requestHeaders(): array
    {
        return [
            ...
            'Origin' => 'https://timesofindia.com',
            'Referer' => 'https://timesofindia.com/',
            'X-Requested-With' => 'XMLHttpRequest',
            'X-Scanner-Connector' => 'indiatimes',
            'X-Scanner-Category' => 'news',
            'Host' => 'timesofindia.com',
        ];
    }
