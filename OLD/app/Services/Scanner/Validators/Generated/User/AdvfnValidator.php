...
final class AdvfnValidator extends BaseGeneratedValidator
{
    ...
    {
        return 'https://uk.advfn.com/forum/profile';
    }
    ...
    {
        return "https://uk.advfn.com/forum/profile/{$target}";
    }
    ...
    protected function parseConnectorResponse(Response $response, string $target): array
    {
        ...
        $availableStatuses = [];
        $takenStatuses = [];
        $availableIndicators = ['advfn error - page not found'];
        $takenIndicators = ['profile | advfn'];
