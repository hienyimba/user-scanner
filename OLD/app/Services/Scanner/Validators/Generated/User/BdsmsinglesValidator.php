...
final class BdsmsinglesValidator extends BaseGeneratedValidator
{
    ...
    {
        return 'https://www.bdsmsingles.com/members';
    }
    ...
    {
        return "https://www.bdsmsingles.com/members/{$target}/";
    }
    ...
    protected function parseConnectorResponse(Response $response, string $target): array
    {
        ...
        $availableStatuses = [302];
        $takenStatuses = [200];
        $availableIndicators = ['bdsm singles'];
        $takenIndicators = ['<title>profile'];
