...
final class HamahaValidator extends BaseGeneratedValidator
{
    ...
    {
        return "https://hamaha.net/{$target}";
    }
    ...
    protected function parseConnectorResponse(Response $response, string $target): array
    {
        ...
        $availableStatuses = [];
        $takenStatuses = [];
        $availableIndicators = ['content="hamaha  биткоин форум. торговля на бирже - ➨ обучение криптовалютам, биткоин и nyse '];
        $takenIndicators = ['id="profile'];
