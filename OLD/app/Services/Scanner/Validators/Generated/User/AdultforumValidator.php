...
final class AdultforumValidator extends BaseGeneratedValidator
{
    ...
    {
        return 'https://adultforum.gr/-glamour-escorts';
    }
    ...
    {
        return "https://adultforum.gr/{$target}-glamour-escorts/";
    }
    ...
    protected function parseConnectorResponse(Response $response, string $target): array
    {
        ...
        $availableStatuses = [];
        $takenStatuses = [];
        $availableIndicators = ['page not found - adult forum gr'];
        $takenIndicators = ['glamour escorts '];
